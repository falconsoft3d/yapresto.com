# YaPresto - Sistema de Gestión de Créditos

Aplicación web completa desarrollada con Next.js 14, PostgreSQL, Prisma y autenticación JWT para la gestión profesional de créditos y clientes.
